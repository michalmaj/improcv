...
Small, self-contained, runnable recipes for the two main first-use workflows. Each script is
...
```bash
pip install "improcv[cv-headless]==0.2.0a2"
```
...
Both recipes rely on one convention that is easy to get backwards:
